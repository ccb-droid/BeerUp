...
export function AddBeerDialog({ children }: { children: React.ReactNode }) {
  ...
  const handleLoginSuccess = () => {
    setShowLogin(false)
    // Now that user is logged in, they see the add beer form in the same dialog
    resetForm() // Reset form fields in case they were partially filled before login redirect
  }
